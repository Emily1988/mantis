from mantis.bugs2018 import date
...
def getwkdic_dateRange(beginDate, endDate,dict):
    ...
    for i in range(1, len(dict) + 1):
        str = "wk%s" % i
        wk[str] = []
    for i, _date in enumerate(date.dateRange(beginDate, endDate)):
...
def run_excel(wb,dict,projectname,index):
    ...
    endDate = '2017-01-01'
    monthdict = getwkdic_dateRange(beginDate, endDate, dict)
...
if __name__ == '__main__':
    ...
    for project in projectlist:
        ...
        run_excel(wb,dict,projectname,index)
